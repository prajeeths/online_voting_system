...
<body>
                    ...
                    <form action="process_cand_3.php" method="post">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="txtbranch" required>
                                        ...
                                        <option>artificial intelligence and science</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="td-1"><input required type="text" style="text-align: left;" name="txtEnrollID" id="txtEnrollID"></td>
                            </tr>
                            <tr>
    ...
    <script>
        function generateEnrollmentID() {
            ...
            for (var i = 0; i < 8; i++) {
                enrollmentID += characters.charAt(Math.floor(Math.random() * characters.length));
            }

            
            document.getElementById("txtEnrollID").value = enrollmentID;
        }

        
        window.onload = generateEnrollmentID;
    </script>
